...
def main():
    ...
    # Cuando lo que se escribe ES el board, validamos el CONTENIDO del payload
    # (PreToolUse corre antes de escribir, así que el archivo aún no está en
    # disco). Para hypotheses.md validamos el board que ya existe en disco.
